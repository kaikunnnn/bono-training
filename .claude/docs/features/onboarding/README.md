...
**作成日**: 2025-01-21
**最終更新**: 2025-01-22（確認事項反映）
**ステータス**: 🔄 方針変更・計画中
**関連ブランチ**: `fix/ux-refinements`
...
| # | タスク | ステータス | 優先度 | 備考 |
|---|--------|-----------|--------|------|
| 1 | 有料記事ペイウォールの改修 | ⏳ 未着手 | 🔴最重要 | bo-no.designへの誘導 + モーダルで流れ説明 |
| 2 | ログインページの改修（タブUI） | ⏳ 未着手 | 🔴最重要 | 「通常ログイン」と「初めての方」を分離 |
| 3 | 新規登録画面の改修 | ⏳ 未着手 | 🔴最重要 | 登録フォーム→流れ説明に置き換え |
| 4 | RegistrationFlowGuideコンポーネント作成 | ⏳ 未着手 | 🔴最重要 | ペイウォール・新規登録で共通利用 |
| 5 | ページの非表示化 + 開発用リンク | ⏳ 未着手 | 🟡中 | 詳細は「非表示対象ページ」セクション参照 |
