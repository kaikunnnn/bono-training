...
**ステータス**: 🚀 Phase 1 完了、Phase 2-3 調査完了
**ブランチ**: `feature/roadmap`（暫定）
**開始日**: 2026-03-17

**概要**: コードベース全体のセキュリティ監査と改善

**ドキュメント**: `.claude/docs/security/`
- [SECURITY-AUDIT.md](../security/SECURITY-AUDIT.md) - 監査レポート・改善計画

**完了タスク**:
- [x] Phase 1.1: RLS有効化マイグレーション作成
- [x] Phase 1.2: レース条件修正（upsertパターン）
- [x] Phase 2: XSSリスク箇所の調査
- [x] Phase 3: CORS・センシティブログの調査

**未対応タスク**:
- [ ] RLSマイグレーションの本番適用
- [ ] XSS対策パッケージのインストール・実装
- [ ] CORS設定の厳密化
- [ ] デバッグログの削除
...
- [x] フィードバック一覧・詳細ページ（詳細はフィードバックプラン限定）
  ...
  - [x] モバイル表示確認
- [x] ナレッジ一覧・詳細ページ（「お役立ち」として実装）
  - [x] Sanity Schema作成（knowledge, knowledgeCategory）
  - [x] 一覧ページ（カードグリッド、カテゴリフィルター）
  - [x] 詳細ページ（PortableText、関連記事）
  - [x] サイドバーにナビゲーション追加
- [ ] ベータ版デザイン
