...
export const PlanChangeConfirmModal: React.FC<PlanChangeConfirmModalProps> = ({
  ...
  const newPriceKey =
    `${newPlan.type}_${newPlan.duration}m` as keyof PlanPrices;
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="font-bold text-lg">
              {getPlanDisplayName(currentPlan.type)} {currentPlan.duration}
              ヶ月プラン
            </p>
