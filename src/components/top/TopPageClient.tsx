 ...
 *
 * セクション構成:
 * 1. Hero Section - キャッチコピー + CTAボタン（トレーニングカード）
 * 2. Partnership Section - キャリアパートナーシップ
 * 3. Goal Selection Section - 3つのゴール選択ボタン
...
import type { Lesson as SanityLesson } from "@/types/sanity";

// ============================================
// 型定義
// ============================================

/** LessonCard用のLesson型（LessonCard内部インターフェースに準拠） */
...
/**
 * SanityLessonをLessonCard用のLesson型に変換
 */
function convertSanityLessonToLesson(sanityLesson: SanityLesson): LessonCardLesson {
  const categoryValue =
...
export default function TopPageClient({ roadmaps, lessons }: TopPageClientProps) {
