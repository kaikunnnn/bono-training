    ...
    return (
      <div className="w-full text-gray-900">
        <div className="border-b border-gray-200 mb-[32px]">
          <span className="font-geist font-medium text-sm md:text-base px-4 md:px-6 py-2 md:py-3 inline-block border-b-2 border-black text-black">
            コンテンツ
          </span>
        </div>
    ...
    <div className="w-full">
      ...
      >
        <TabsList className="w-full justify-start border-b border-gray-200 bg-transparent rounded-none h-auto p-0 mb-[32px]">
          <TabsTrigger
            value="content"
            className="font-geist font-medium text-sm md:text-base px-4 md:px-6 py-2 md:py-3 rounded-none border-b-2 border-transparent data-[state=active]:border-black data-[state=active]:text-black data-[state=active]:bg-transparent data-[state=inactive]:text-gray-400 bg-transparent shadow-none"
          >
            コンテンツ
          </TabsTrigger>
          <TabsTrigger
