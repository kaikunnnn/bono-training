...
export default function RoadmapPreview() {
  ...
  // データを整形
  const gradientPreset = (roadmap.gradientPreset || "galaxy") as GradientPresetType;
      ...
      <div className={isPageMode ? "" : "py-8 space-y-16"}>
        ...
        {!isPageMode && (
          <div className="max-w-[1200px] mx-auto px-4">
            ...
            {/* データ状況 */}
            <div className="bg-green-50 border-green-200 border rounded-lg p-4 mb-8">
        ...
        {/* SectionNav（ページモード時のみ表示） */}
        {isPageMode && sectionNavItems.length > 0 && (
          <SectionNav items={sectionNavItems} />
        )}

        {/* SectionNav（コンポーネントモード時） */}
        {!isPageMode && sectionNavItems.length > 0 && (
          <section className="mt-16">
            <div className="max-w-[1200px] mx-auto px-4 mb-4">
              <h2 className="text-lg font-bold text-gray-700">1.5. SectionNav</h2>
            </div>
            <SectionNav items={sectionNavItems} />
          </section>
        )}
