/**
 * セクション4の記事0を、確認用のSanity development datasetへ反映する。
...
const ARTICLE_ID = "sbd-section4-dev-session";
const TITLE = "セッション4：次のデザインへつなげよう";
const SOURCE_PATH =
  "/Users/kaitakumi/Documents/01_BONO事業/01_Docs/rebono/ペルソナと課題でデザインするフロー/Step4-セクション4をどうするのか/0. セッション4：次のデザインへつなげよう.md";
